          ...
          <div>
            ...
            {step === 5 && (
              <div className="max-w-xl mx-auto w-full text-left py-4">
                <h2 className="text-2xl font-black text-black mb-2 text-center tracking-tight">Quem receberá as propostas de sinal?</h2>
                <p className="text-slate-500 text-xs mb-8 text-center font-medium">Informe seus dados para a emissão do contrato de reserva digital.</p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className={labelClass}>CEP do Anúncio *</label>
